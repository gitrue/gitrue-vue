      ...
      <div class="hero is-fullheight">
        <div class="hero-heading">
          ...
          <div class="section has-text-centered">
            <router-link to="/"
              ><img class="top-logo" src="" alt="Brand"
            /></router-link>
          </div>
              ...
              <div class="column is-5">
                ...
                <div id="partialUserResetForm">
                  ...
                  >
                    ...
                    <p class="control login">
                      <button
                        type="submit"
                        class="button button-cta secondary-btn btn-align-lg btn-outlined is-bold is-fullwidth rounded raised no-lh will-load"
                      >
                        Restore password
                      </button>
                    </p>
                ...
                >
                  ...
                  <p>
                    ...
                    >
                      <a
                        href="https://github.com/login/oauth/authorize?client_id=b371e2de74a7b1a56ca4&scope=user:email"
                      >
